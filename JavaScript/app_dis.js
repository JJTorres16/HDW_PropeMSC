  ...
  var altura_str = document.getElementById("Altura_dis").value;
      ...
      if (base_str == "") {
        document.getElementById("Base_dis").focus();
            ...
            if (altura_str == ""){
              document.getElementById("Altura_dis").focus();
            } else {
              document.getElementById("Base_dis").value = "";
              document.getElementById("Altura_dis").value = "";
              document.getElementById("Base_dis").focus();
          }
       }
      ...
      document.getElementById("val_area").innerHTML = area_new;
          ...
          if (cantidad_horizontal > 1 || cantidad_horizontal == 0){
              document.getElementById("cant_hor_dis").innerHTML = cantidad_horizontal + " veces";
                  ...
                  document.getElementById("cant_hor_dis").innerHTML = cantidad_horizontal + " vez";
                  }

                  if (cantidad_vertical > 1 || cantidad_vertical == 0){
                      document.getElementById("cant_vert_dis").innerHTML = cantidad_vertical + " veces";
                      } else {
                          document.getElementById("cant_vert_dis").innerHTML = cantidad_vertical + " vez";
                          }

/************************************************************************************************************************/

                          if (relacion_areas > 1 || relacion_areas == 0){
                              document.getElementById("cant_mat_dis").innerHTML = relacion_areas.toFixed(2) + " veces";
                              } else {
                                  document.getElementById("cant_mat_dis").innerHTML = relacion_areas.toFixed(2) + " vez";
                                }
